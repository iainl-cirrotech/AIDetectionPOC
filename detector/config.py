...
class Settings:
    def __init__(self) -> None:
        ...
        self.classifier_mode = os.getenv("DETECTOR_CLASSIFIER", "hf").strip().lower()
        self.model_id = os.getenv("DETECTOR_MODEL_ID", "capcheck/ai-human-generated-image-detection")
        self.model_revision = os.getenv("DETECTOR_MODEL_REVISION", "")
        self.model_version = os.getenv("DETECTOR_MODEL_VERSION", "1.0.0")
